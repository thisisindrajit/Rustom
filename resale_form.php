  ...
  <body>
    <div class="testbox">
      ...
      <div class="item">
		...
		<div class="name-item">
          <input type="number" name="kmdriven" placeholder="Kilometers driven (in numbers only)" min="0"  required>
          <input type="number" name="resaleprice" placeholder="Resale Price (in numbers only)" min="0"  required>
        </div>    
